...
def ai_chat():
    ...
    try:
        ...
        desmos_sys_prompt = (
            ...
            "2. STRICT SYNTAX RULE: NEVER use '#' or '//' for comments in desmos code blocks. Desmos LaTeX parser fails on '#'. Only output valid mathematical equations, variable assignments, and parametric points.\n"
            "3. Use standard variables and sliders (e.g. t = 0, a = 1, f = 1), parametric functions (e.g. (v_0 \\cdot t \\cdot \\cos(\\theta), v_0 \\cdot t \\cdot \\sin(\\theta) - 0.5 \\cdot g \\cdot t^2)), and equations.\n"
            "Example:\n"
            "```desmos\n"
            "v_0 = 20\n"
            "\\theta = 0.785\n"
